						...
						User.findOne({id :  req.token.sid}).exec(function(err, user){
							...
							Property.findOne({property_id: property_id }).exec(function(err, property_details){
								...
								if(user.company_id ==  property_details.company_id ){
									...
									var qry = "select property_subitem_link.prop_subitem_id, property_subitem_link.property_id, property_subitem_link.com_subitem_id, property_subitem_link.prop_master_id as sub_prop_master_id, property_subitem_link.item_name, property_subitem_link.type, property_subitem_link.priority, property_subitem_link.status, property_subitem_link.mb_createdAt, property_subitem_link.createdAt, property_subitem_link.updatedAt, property_masteritem_link.prop_master_id,property_masteritem_link.name as master_item_name, property_feedback.prop_feedback_id, property_feedback.comment, property_feedback.description, property_feedback.option from property_subitem_link INNER JOIN property_masteritem_link on property_subitem_link.prop_master_id = property_subitem_link.prop_master_id LEFT JOIN (SELECT property_feedback.prop_feedback_id, property_feedback.item_id, property_feedback.comment, property_feedback.description, property_feedback.option, property_feedback.parent_id FROM property_feedback WHERE property_feedback.parent_id = '" + prop_master_id + "' ) as property_feedback on property_subitem_link.prop_subitem_id = property_feedback.item_id where property_subitem_link.status =1 and property_masteritem_link.prop_master_id ='" + prop_master_id +"' and property_subitem_link.prop_master_id ='" + prop_master_id +"' and property_subitem_link.property_id='" + property_id + "' order by property_subitem_link.priority";
