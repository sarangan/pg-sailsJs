        ...
        if(total_photos[po].file_name){
          ...
          if(report_settings.photo_collection_layout ==  '2-COL'){
            ...
            total_photo_html += '<div style="width: 30%; background-color: #ffffff; display: inline-block; margin: 5px; max-width: 300px;">' +
               '<div style="padding: 1px; background-color: #ffffff; display: inline-block; ">' +
             ...
             '<html lang="en"><style type="text/css" media="screen,print">'+
                '<head>' +
                 ...
                 '<style type="text/css" media="screen,print">' +
                   ...
                   '.rt-2-tbl-img{ width: 100%; height: auto;padding:1px; border:1px solid #021a40; -webkit-transform: rotate(90deg);-moz-transform: rotate(90deg); -ms-transform: rotate(90deg); -o-transform: rotate(90deg); transform: rotate(90deg);}' +
