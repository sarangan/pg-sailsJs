        ...
        for(var j =0, sl = master_item.sub.length; j < sl ; j++){ // sub item loop
          ...
          if(sub_item.photos){
              ...
              for(var l =0, pl = sub_item.photos.length; l < pl ; l++){
                ...
                var temp_image_url = 'http://propertyground.co.uk/cropper/phpThumb.php?src=' + encodeURIComponent(server_image_path +  property_id + '/' + '' + (sub_item.photos[l].file_name.substr(0, sub_item.photos[l].file_name.lastIndexOf('.')) || sub_item.photos[l].file_name) + '.jpg') +'&w=300&h=300';
         ...
         if(desc){
          ...
          if(option){
           ...
           var temp_sub_items_html = '<div class="divrow" style="padding:0px; padding-left: 10px; margin-bottom: 15px; padding-right: 1px; border:none;color:' + report_settings.table_header_color + '; background-color:' + table_header_bg_color_light +'">' +
             ...
             '<div style="width: 38.7%; display:inline-block; text-align: right;">' + temp_sub_items_html_maintaince + '</div>' +
           '</div>';
