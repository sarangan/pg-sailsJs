  ...
  for(var i =0, masterl = temp_master_items.length; i < masterl; i++){
    ...
    if(report_settings.items_details_layout == 'STYLE 1'){
      ...
      if(master_item.type == 'SUB' ){
        ...
        if(master_item.temp_top_photos){
          ...
          for(var j =0, tl = master_item.temp_top_photos.length; j < tl ; j++){
            ...
            //sails.log(server_image_path +  property_id + '/' + '300_' + (master_item.temp_top_photos[j].file_name.substr(0, master_item.temp_top_photos[j].file_name.lastIndexOf('.')) || master_item.temp_top_photos[j].file_name) + '.jpg')
        ...
        var temp_sub_items_html = '<div class="divrow">' +
         ...
         if(master_item.photos){
             for(var l =0, pl = master_item.photos.length; l < pl ; l++){
               ...
               if(l < 3){
                 photos_html += '<div class="img-wrapper1">' +
                    '<img src="' + server_image_path +  property_id + '/' + '300_' + (master_item.photos[l].file_name.substr(0, master_item.photos[l].file_name.lastIndexOf('.')) || master_item.photos[l].file_name) + '.jpg' + '" alt="img" class="rt-1-img" />' +
                    '<div style="font-style: italic; color: #a0a0a0; text-align: left;">'+ photo_date +'</div>'+
                    '<div>' +
                ...
                for(var l =0, pl = master_item.temp_top_photos.length; l < pl ; l++){
                  ...
                  if(master_item.temp_top_photos[l].file_name){
                    photos_bottom_html += '<div style="width: 20%; padding: 10px; background-color: #e1e1e1; display: inline-block; margin: 5px; max-width: 300px; margin-top: 20px;">' +
                       '<img src="' + server_image_path +  property_id + '/' + '300_' + (master_item.temp_top_photos[l].file_name.substr(0, master_item.temp_top_photos[l].file_name.lastIndexOf('.')) || master_item.temp_top_photos[l].file_name) + '.jpg' + '" alt="img" class="rt-2-tbl-img" />' +
                       '<div style="font-style: italic; color: #a0a0a0; text-align: left;">'+ photo_date +'</div>'+
      ...
      if(master_item.type == 'SUB' ){
        ...
        for(var j =0, sl = master_item.sub.length; j < sl ; j++){ // sub item loop
         ...
         if(desc){
          ...
          if(option){
           ...
           var temp_sub_items_html = '<div class="divrow" style="padding:0px; padding-left: 10px; margin-bottom: 15px; padding-right: 10px; border:none;color:' + report_settings.table_header_color + '; background-color:' + table_header_bg_color_light +'">' +
       ...
       var temp_sub_items_html = '<div class="divrow" style="padding:0px; padding-left: 10px; padding-right: 10px; margin-bottom: 15px; border:none;color:' + report_settings.table_header_color + '; background-color:' + table_header_bg_color_light +'">' +
